...
#CFLAGS += -I/sw/gaea-c7/spack/envs/env_26.06/opt/gcc-16.1.0/mpich-5.0.1-zxiyhjhgfmbvpco4bqr5cz57gxbx4ung/include//
#FFLAGS += -I/sw/gaea-c7/spack/envs/env_26.06/opt/intel-oneapi-compilers-2026.0.0/hdf5-1.14.6-zdnbfmgiskvqdhgbqyqc35wisx7yveeh/include/
CFLAGS += $(shell pkg-config --cflags mpich)
...
LIBS += $(shell pkg-config --libs hdf5) -lhdf5_fortran #-lhdf5
LIBS += $(shell pkg-config --libs netcdf) # -lnetcdf
LIBS += $(shell nf-config --flibs) # -lnetcdff
#LIBS += -L/sw/gaea-c7/spack/envs/env_26.06/opt/intel-oneapi-compilers-2026.0.0/hdf5-1.14.6-zdnbfmgiskvqdhgbqyqc35wisx7yveeh/lib -lhdf5 -lhdf5_fortran
#LIBS += -L/sw/gaea-c7/spack/envs/env_26.06/opt/gcc-16.1.0/mpich-5.0.1-qo4ajf4zf6wvmf4g7zl5d2rqdscziwr4/lib
#LIBS += -L/sw/gaea-c7/spack/envs/env_26.06/opt/intel-oneapi-compilers-2026.0.0/netcdf-c-4.10.0-boppdvp6rljo4drizcdqvc3ysg2mulp3/lib64
#LIBS += -L/sw/gaea-c7/spack/envs/env_26.06/opt/intel-oneapi-compilers-2026.0.0/netcdf-c-4.10.0-6ubkqwwn3dfncrtugi4bibdmc67bvfid/lib64 -L/sw/gaea-c7/spack/envs/env_26.06/opt/intel-oneapi-compilers-2026.0.0/netcdf-fortran-4.6.2-rozibsttmb3ov2fvprsf2j5sxr46mzru/lib/ -lnetcdff -lnetcdf
