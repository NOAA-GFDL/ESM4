...
CFLAGS_DEBUG = -O0 -g -ftrapv $(ISA_DEBUG)
...
#To use intel-mpi
#LIBS += -L/usr/local/netcdf/oneapi-2024.2/hdf5-1.14.4/intel-mpi/4.9.2/lib64
#LIBS += -L/usr/local/hdf5/oneapi-2024.2/intel-mpi/1.14.4/lib64
#To use open-mpi
