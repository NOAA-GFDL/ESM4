# Earth System Model 4.5

## What Is Included
* [src]((https://github.com/NOAA-GFDL/ESM4/tree/esm45_pubrel/src) source code for the ESM4 model (all code is in submodules)
* [exec]((https://github.com/NOAA-GFDL/ESM4/tree/esm45_pubrel/exec) Files to compile the code in a container
* [run]((https://github.com/NOAA-GFDL/ESM4/tree/esm45_pubrel/run) Simple run script
* [misc]((https://github.com/NOAA-GFDL/ESM4/tree/esm45_pubrel/misc) Miscellaneous tools to help users for build/run

## Cloning
To clone the ESM4 model please use the recursive option
```bash
git clone --recursive -b esm45_pubrel https://github.com/NOAA-GFDL/ESM4.git esm45_pubrel
cd esm45_pubrel
```
...
module unload netcdf-c netcdf-fortran hdf5
module load mpich
exec=PATH_TO_USER_EXECUTABLE

srun --ntasks=216 --cpus-per-task=2 --export=ALL,OMP_NUM_THREADS=2 $exec : --ntasks=1720 --cpus-per-task=1 --export=ALL,OMP_NUM_THREADS=1 $exec
```
